<template>
	<div class="main-content" :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('jiedanxinxi','上门')" @click="shangmenfuwuCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<shangmenfuwu-cross-add-or-update v-if="shangmenfuwuCrossAddOrUpdateFlag" :parent="this" ref="shangmenfuwuCrossaddOrUpdate"></shangmenfuwu-cross-add-or-update>
...
import shangmenfuwuCrossAddOrUpdate from "../shangmenfuwu/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				shangmenfuwuCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			shangmenfuwuCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.shangmenfuwuCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.shangmenfuwuCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.shangmenfuwuCrossaddOrUpdate.init(row.id,type);
				});
			},

	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="用户操作" prop="operation">
					<el-input v-model="ruleForm.operation" placeholder="用户操作" clearable  :readonly="ro.operation"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="用户操作" prop="operation">
					<el-input v-model="ruleForm.operation" placeholder="用户操作" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="请求方法" prop="method">
					<el-input v-model="ruleForm.method" placeholder="请求方法" clearable  :readonly="ro.method"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="请求方法" prop="method">
					<el-input v-model="ruleForm.method" placeholder="请求方法" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="请求时长(毫秒)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="请求时长(毫秒)" clearable  :readonly="ro.time"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="请求时长(毫秒)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="请求时长(毫秒)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="IP地址" prop="ip">
					<el-input v-model="ruleForm.ip" placeholder="IP地址" clearable  :readonly="ro.ip"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="IP地址" prop="ip">
					<el-input v-model="ruleForm.ip" placeholder="IP地址" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="请求参数" prop="params">
					<el-input
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.params" label="请求参数" prop="params">
					<span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.params}}</span>
				</el-form-item>
